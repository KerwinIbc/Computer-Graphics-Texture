...
float NowS0, NowT0, NowD,NowR,NowSc,NowTc,NowUTL;
GLSLProgram Pattern;
Keytimes Aa,Bb,Dd,Tol,NoiseAmp,NoiseFreq;
...
Display( )
{
    ...
    float amp = 2.7;
    float freq = 1.2;
    Pattern.SetUniformVariable( (char *)"uNoiseAmp" , amp  );
    //Pattern.SetUniformVariable( (char *)"uNoiseAmp" , NoiseAmp.GetValue(nowTime)  );
    Pattern.SetUniformVariable( (char *)"uNoiseFreq" , freq );
    ...
    //float Xx = 30.0;
    float Yy = -50.;
    Pattern.SetUniformVariable( (char *)"uA" , Aa.GetValue(nowTime));
    Pattern.SetUniformVariable( (char *)"uB" , Bb.GetValue(nowTime));
    Pattern.SetUniformVariable( (char *)"uC" , Cc );
    Pattern.SetUniformVariable( (char *)"uD" , Dd.GetValue(nowTime));
    Pattern.SetUniformVariable((char *)"sign",Nowsign);
    glCallList(Quadlist);
...
InitGraphics( )
{
    ...
    //Pattern.SetUniformVariable((char*)"Noise3",texture);
	Pattern.UnUse( );
    Aa.Init();
    Aa.AddTimeValue(0.,0.3);
    Aa.AddTimeValue(2.,0.6);
    Aa.AddTimeValue(4.,0.9);
    Aa.AddTimeValue(7.,0.4);
    Aa.AddTimeValue(10.,0.6);
    Bb.Init();
    Bb.AddTimeValue(0.,0.7);
    Bb.AddTimeValue(3.,1.3);
    Bb.AddTimeValue(6.,1.4);
    Bb.AddTimeValue(9.,2.4);
    Bb.AddTimeValue(10.,2.7);
    Dd.Init();
    Dd.AddTimeValue(0.,0.7);
    Dd.AddTimeValue(3.,1.1);
    Dd.AddTimeValue(6.,1.2);
    Dd.AddTimeValue(9.,1.6);
    Dd.AddTimeValue(10.,2.0);

    Tol.Init();
    Tol.AddTimeValue(0.,0.);
    Tol.AddTimeValue(0.3,0.4);
    Tol.AddTimeValue(0.6,0.2);
    Tol.AddTimeValue(0.8,0.6);
    Tol.AddTimeValue(10.,0.9);
    NoiseAmp.Init();
    NoiseAmp.AddTimeValue(0.,0.79);
    NoiseAmp.AddTimeValue(2.,1.48);
    NoiseAmp.AddTimeValue(4.,1.9);
    NoiseAmp.AddTimeValue(7.,2.1);
    NoiseAmp.AddTimeValue(10.,3.2);
    NoiseFreq.Init();
    NoiseFreq.AddTimeValue(0,1.87);
    NoiseFreq.AddTimeValue(2,3.0);
    NoiseFreq.AddTimeValue(4,3.7);
    NoiseFreq.AddTimeValue(7,1.3);
    NoiseFreq.AddTimeValue(10,0.7);
...
InitLists( )
{
    ...
    float xmin = -1.5f;	// set this to what you want it to be
    float xmax =  1.5f;	// set this to what you want it to be
    float ymin = -1.5f;	// set this to what you want it to be
    float ymax =  1.5f;	// set this to what you want it to be
    float dx = xmax - xmin;
    float dy = ymax - ymin;
    float z = 0.2f;		// set this to what you want it to be
